...
if __name__ == "__main__":
    ...
    theoretical_path = "../experiment_theory_strategies/extortion_mapping.txt"
    theoretical_strategy = np.loadtxt(theoretical_path)

    delay_path_template = "eps_greedy_d{:.2f}/optimised_params.txt"
    delays = [0.0,  1.0]
    strategies = {}
    ...
    for delay in delays:
        ...
        plt.plot(prices_follower, prices_leader, label=f"Delay $\delta={delay:.1f}$")
    plt.plot(
